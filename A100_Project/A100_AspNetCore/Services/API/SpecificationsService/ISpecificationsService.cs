...
namespace A100_AspNetCore.Services.API.SpecificationsService
{
    public interface ISpecificationsService
    {
        ...
        Task<List<DTODefectType>> GetDefectTypes();
        ...
        Task<List<v_GetElementSize>> GetSpecificationsElementSizes(int SpecificationsElementID);

        Task<List<DTOSpecificationsSize>> GetSpecificationsWithSizes(int SpecificationsID);
