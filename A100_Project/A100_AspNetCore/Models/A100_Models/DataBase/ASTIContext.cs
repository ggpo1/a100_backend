...
namespace A100_AspNetCore.Models.A100_Models.DataBase
{
    public partial class ASTIContext : DbContext
    {
        ...
        public virtual DbQuery<v_GetVikByUnit> v_GetVikByUnit { get; set; }
        public virtual DbQuery<v_GetUnitNames> v_GetUnitNames { get; set; }
        ...
        // Таблицы        
        public virtual DbSet<CameraEvents> CameraEvents { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=ASTI\\ASTISQL;Database=ASTI;Trusted_Connection=False;MultipleActiveResultSets=True; User ID=sa;Password=gbhjcKJK4509");
            }
        }
